...
public class TwoPieceCenterLineTEST extends Command {
    ...
    double driveTimeSeconds2 = 7;
    double driveTimeSeconds3 = 6;
    ...
    public Command SourceCenterLine3Piece() {
        return driveSide
                .andThen(Commands.print("CENTER 2 Start"))
                ...
                .andThen(driveBack)
                .andThen(Commands.print("CENTER 2 END"))
