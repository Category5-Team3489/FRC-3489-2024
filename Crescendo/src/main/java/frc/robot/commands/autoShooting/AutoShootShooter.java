...
// public static ArrayList<DataPoint> getClosestDistanceIndicies(double
// distance) {
...
// double nextHeight =
// Constants.AprilLimelight.ShooterDistanceTable[nextDistance].y;
// double closeHeight =
// Constants.AprilLimelight.ShooterDistanceTable[closeDistance].y;

// if (closeHeight < nextHeight) { // if the closesed distance's height < the
// second closesed distances height
...
// return new ShooterSetting(Constants.General.lerp(settingA.shooterSpeed,
// settingB.shooterSpeed, t),
